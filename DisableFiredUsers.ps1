...
foreach ($filial in $filials)
{
	...
	Send-MailMessage -From "hotline@belwest.com" -To $mail, $copy -Subject "$subject" -Body "$text" -BodyAsHtml -Credential $creds -SmtpServer "mail.belwest.com" -UseSsl -Encoding UTF8
